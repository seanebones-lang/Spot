...
test.describe("Navigation - Routing and Links", () => {
  ...
  test.describe("Sidebar Navigation", () => {
    ...
    test("should navigate to Search when Search link clicked", async ({
      page,
    }) => {
      const searchLink = page
        .locator('a[href="/search"]')
        .or(page.getByText("Search"))
        .first();
    ...
    test("should navigate to Library when Library link clicked", async ({
      page,
    }) => {
      const libraryLink = page
        .locator('a[href="/collection"]')
        .or(page.getByText(/Your Library|Library/))
        .first();
  ...
  test.describe("Playlist Navigation", () => {
    test("should navigate to playlist page when playlist clicked", async ({
      page,
    }) => {
  ...
  test.describe("Artist Navigation", () => {
    test("should navigate to artist page when artist link clicked", async ({
      page,
    }) => {
  ...
  test.describe("Breadcrumbs", () => {
    test("should show breadcrumbs on nested pages", async ({ page }) => {
      ...
      const breadcrumbs = page
        ...
        .or(page.locator('div[class*="breadcrumb"]'));
