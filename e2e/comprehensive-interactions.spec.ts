...
<<<<<<< HEAD
  const player = page
    .locator('div[role="region"][aria-label*="Audio player" i]')
...
async function getAllClickableElements(page: any) {
  return page.locator(
    'button, a[href], [role="button"], [onclick], [class*="cursor-pointer"]',
  );
}

async function getAllMovableElements(page: any) {
  return page.locator(
    '[role="slider"], [role="progressbar"], [draggable="true"], [class*="draggable"]',
  );
}
  ...
  test.describe("Home Page - All Buttons", () => {
    test("should test every button on home page", async ({ page }) => {
      ...
      test.info().annotations.push({
        type: "info",
        description: `Found ${count} buttons on home page`,
      });
...
<<<<<<< HEAD
    ...
    test("should test shuffle button", async ({ page }) => {
      ...
      const shuffleButton = page
        .locator('button[aria-label*="Shuffle" i]')
        .first();
=======
...
<<<<<<< HEAD
    test("should test repeat button", async ({ page }) => {
      ...
      const repeatButton = page
        .locator('button[aria-label*="Repeat" i]')
        .first();
=======
    test('should test repeat button', async ({ page }) => {
      const playButton = page.locator('button[aria-label*="Play" i]').first();
...
<<<<<<< HEAD
    test("should test next/previous buttons", async ({ page }) => {
      ...
      const prevButton = page
        .locator('button[aria-label*="Previous" i]')
        .first();
...
<<<<<<< HEAD
    test("should test queue button", async ({ page }) => {
      ...
      const queueButton = page
        .locator('button[aria-label*="Queue" i], button[title*="Queue" i]')
        .first();
      if (await queueButton.isVisible().catch(() => false)) {
        ...
        const closeButton = page
          .locator(
            'button[aria-label*="close" i], button:has-text("×"), button:has-text("X")',
          )
          .first();
=======
    test('should test queue button', async ({ page }) => {
...
<<<<<<< HEAD
    test("should test full screen button", async ({ page }) => {
      ...
      const fullScreenButton = page
        .locator(
          'button[aria-label*="full screen" i], button[title*="Full screen" i]',
        )
        .first();
...
<<<<<<< HEAD
    test("should test equalizer button", async ({ page }) => {
      ...
      const eqButton = page
        .locator(
          'button[aria-label*="equalizer" i], button[title*="Equalizer" i]',
        )
        .first();
...
<<<<<<< HEAD
        ...
        const indicator = progressBar
          .locator("div.rounded-full.bg-white")
          .first();
=======
  ...
  test.describe("Volume Control - Movable Elements", () => {
    test("should test volume slider", async ({ page }) => {
      const volumeControl = page
        .locator('div[aria-label*="volume" i], button[aria-label*="volume" i]')
        .first();
...
<<<<<<< HEAD
        ...
        const volumeSlider = page
          .locator('div[role="slider"][aria-label*="volume" i]')
          .first();
...
<<<<<<< HEAD
  test.describe("Navigation - All Pages", () => {
    ...
    for (const pagePath of pages) {
      test(`should load and test interactions on ${pagePath}`, async ({
        page,
      }) => {
        try {
...
<<<<<<< HEAD
  test.describe("Context Menus - Right Click Interactions", () => {
    test("should test right-click context menus", async ({ page }) => {
      ...
      const clickableItems = page
        .locator('div[class*="cursor-pointer"], div[class*="card"]')
        .first();
      ...
      if (await clickableItems.isVisible().catch(() => false)) {
        ...
        const contextMenu = page
          .locator('div[role="menu"], div[class*="context-menu"]')
          .first();
  ...
  test.describe("Modal Interactions", () => {
    test("should test modal open/close", async ({ page }) => {
      ...
      const modalTriggers = page.locator(
        'button[aria-haspopup="dialog"], button[aria-label*="open" i]',
      );
