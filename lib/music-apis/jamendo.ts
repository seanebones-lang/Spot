...
export async function getTracksByMood(mood: string, limit: number = 50): Promise<JamendoTrack[]> {
...
export async function getTracksByGenre(genre: string, limit: number = 50): Promise<JamendoTrack[]> {
