...
<<<<<<< HEAD
      <div
        ...
        style={{
          transition:
            "transform 300ms cubic-bezier(0.3, 0, 0.1, 1), opacity 200ms ease-out",
=======
      <div 
        className={cn(
          "bg-spotify-dark-gray w-full max-w-md h-[70vh] rounded-t-2xl flex flex-col transform transition-transform duration-300 ease-out",
...
<<<<<<< HEAD
                  if (
                    window.confirm(
                      "Are you sure you want to clear the queue? This will remove all tracks.",
                    )
                  ) {
=======
...
<<<<<<< HEAD
              <div className="text-xs text-spotify-text-gray mb-2">
                Now Playing
              </div>
              <div className="flex items-center gap-3">
            ...
            <div
              ...
              className={cn(
                ...
                dragOverIndex === index &&
                  ...
                  "bg-white/20 border-l-4 border-spotify-green transform translate-x-1",
              )}
              style={{
                transition:
                  draggedIndex === index || dragOverIndex === index
...
=======
          {/* Use virtualization for large queues (50+ tracks) */}
          {queue.length > 50 ? (
