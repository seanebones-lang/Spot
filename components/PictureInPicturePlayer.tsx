...
<<<<<<< HEAD
      ...
      container.style.cssText =
        "background: #121212; color: white; padding: 16px; height: 100%; display: flex; flex-direction: column; font-family: system-ui;";
...
<<<<<<< HEAD
      ...
      coverContainer.style.cssText =
        "width: 64px; height: 64px; background: #282828; border-radius: 4px; flex-shrink: 0; display: flex; align-items: center; justify-content: center;";
      ...
      if (currentTrack?.coverArt) {
        ...
        imgEl.onerror = () => {
          ...
          fallback.style.cssText =
            "width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: #282828;";
          fallback.innerHTML =
            '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18V5l12-2v13M9 18l12-2M9 18l6-12m6 12l-6-12m-12 0v13m12-13v13"/></svg>';
=======
      const trackSection = pipWindow.document.createElement('div');
...
<<<<<<< HEAD
      ...
      prevBtn.style.cssText =
        "background: transparent; border: none; color: #b3b3b3; cursor: pointer; padding: 4px; font-size: 16px;";
      prevBtn.textContent = "⏮";
