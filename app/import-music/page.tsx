...
import Link from 'next/link';
import { Upload, Music, FileAudio, ArrowRight, CheckCircle2 } from 'lucide-react';
...
=======
          ...
          >
            Upload your music to EmPulse and share it with the world. Get started in minutes.
>>>>>>> 460cde8a4456665eaca40b34f2a2a146c789ce1e
          </p>
        </div>
...
=======
                title: 'Upload Tracks',
                description: 'Upload singles, EPs, or full albums in WAV, FLAC, MP3, or M4A format.',
                href: '/upload',
                action: 'Start Uploading'
              },
              {
                icon: Music,
                title: 'Bulk Import',
                description: 'Import entire catalogs with our bulk upload tool for artists and labels.',
                href: '/upload',
                action: 'Learn More'
              },
              {
                icon: FileAudio,
                title: 'Import Playlists',
                description: 'Import playlists from Spotify, Apple Music, or other platforms.',
                href: '/collection',
                action: 'Import Now'
              }
>>>>>>> 460cde8a4456665eaca40b34f2a2a146c789ce1e
...
=======
            ...
            >
              Join thousands of independent artists sharing their music on EmPulse.
>>>>>>> 460cde8a4456665eaca40b34f2a2a146c789ce1e
            </p>
