    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Take your music everywhere. Download the free EmPulse Music app for iOS and Android.
          </p>
        </div>
            ...
            {[
              {
                ...
                description: 'Download your favorite tracks and playlists to listen offline, anywhere.'
              },
              {
                icon: Download,
                title: 'Instant Sync',
                description: 'Your playlists, favorites, and listening history sync seamlessly across all devices.'
              },
              {
                icon: QrCode,
                title: 'Connect Devices',
                description: 'Use Spotify Connect to play music on any device from your phone.'
              }
            ].map((feature, index) => (
              <div
                key={index}
