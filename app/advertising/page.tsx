...
import Link from 'next/link';
import { Megaphone, Users, Target, BarChart3, Zap, CheckCircle2 } from 'lucide-react';
...
=======
          ...
          >
            Reach millions of music lovers worldwide with targeted advertising that connects 
            brands with engaged listeners.
>>>>>>> 460cde8a4456665eaca40b34f2a2a146c789ce1e
          </p>
        </div>
...
=======
                  title: '5M+ Listeners',
                  description: 'Reach millions of engaged music lovers worldwide'
                },
                {
                  icon: Target,
                  title: 'Targeted Ads',
                  description: 'Precise targeting based on listening behavior and preferences'
                },
                {
                  icon: BarChart3,
                  title: 'Real Analytics',
                  description: 'Detailed insights and campaign performance metrics'
                },
                {
                  icon: Zap,
                  title: 'High Engagement',
...
=======
                title: 'Audio Ads',
                description: 'Reach listeners with audio advertisements between songs. Perfect for brand storytelling and music-related campaigns.'
              },
              {
                title: 'Display Ads',
                description: 'Visual banner advertisements on the platform. Engage users with eye-catching creative and clear calls-to-action.'
              },
              {
                title: 'Sponsored Playlists',
                description: 'Feature your brand in curated playlists. Connect with listeners through music discovery and brand alignment.'
              },
              {
                title: 'Video Ads',
                description: 'Video advertisements during playback breaks. Maximize engagement with rich media and compelling narratives.'
              }
>>>>>>> 460cde8a4456665eaca40b34f2a2a146c789ce1e
            ].map((format, index) => (
              <div
...
=======
            ...
            >
              Ready to reach millions of music lovers? Contact our advertising team to discuss 
              campaign opportunities and pricing.
            </p>
            <Link
              href="/support"
