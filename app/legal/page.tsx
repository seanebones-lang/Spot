...
const legalPages = [
  {
    ...
    description:
      "Complete legal terms and conditions including upload requirements, warranties, and indemnification clauses.",
    href: "/legal/terms",
    icon: FileText,
  ...
  },
  {
    ...
    description:
      "How we collect, use, and protect your data. Includes information about IP tracking, legal declarations, and GDPR/CCPA compliance.",
    href: "/legal/privacy",
    icon: Shield,
  ...
  },
  {
    title: "DMCA Policy",
    description:
      "Takedown procedures, counter-notification process, and copyright dispute resolution. Contact information for our DMCA agent.",
    href: "/legal/dmca",
    icon: Copyright,
  ...
  },
  {
    ...
    description:
      "How royalties work, payout schedules, revenue share model ($0.004/stream), and tax requirements for artists.",
  ...
  },
  {
    ...
    description:
      "How to register with ASCAP, BMI, SESAC, or GMR to collect performance royalties. Includes registration steps and royalty flow explanation.",
        ...
        <div className="bg-yellow-600/20 border border-yellow-600/50 rounded-lg p-6 mb-8">
          ...
          <div className="space-y-2 text-sm text-white/80">
            <p>
              ...
              . All uploads must comply with U.S. copyright law and include
              complete metadata for royalty distribution.
            </p>
            <p>
              <strong>Performance Royalties:</strong> Register with a PRO
              (ASCAP, BMI, SESAC, or GMR) to collect performance royalties. See
              our{" "}
              <Link
                href="/legal/pro-guide"
                className="text-spotify-green hover:underline"
            ...
            <p>
              <strong>Copyright Disputes:</strong> If you believe content
              infringes your copyright, see our{" "}
              <Link
                href="/legal/dmca"
                className="text-spotify-green hover:underline"
              >
