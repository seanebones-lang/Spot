  ...
  return (
    ...
    >
      <div className="mb-8">
        ...
        >
          Test Jamendo API integration and verify your API key is configured correctly
        </p>
      </div>
      ...
      <div className="space-y-4 mb-8">
        ...
        >
          ...
          <ol className="list-decimal list-inside space-y-2 text-spotify-text-gray">
            <li>Get your Jamendo API key from https://devportal.jamendo.com/</li>
            <li>Add it to your .env file: <code className="text-spotify-green">JAMENDO_API_KEY=your_key_here</code></li>
            <li>Restart your dev server: <code className="text-spotify-green">npm run dev</code></li>
          ...
          {results.mood && (
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-white mb-1">{results.mood.message}</p>
                {results.mood.data && (
                  <div className="mt-2 text-xs text-spotify-text-gray">
                    ...
                    {results.mood.data.tracks && results.mood.data.tracks.length > 0 && (
                      <div className="mt-2">
                        <p className="font-semibold mb-1">Sample tracks:</p>
                        <ul className="list-disc list-inside space-y-1">
                          {results.mood.data.tracks.slice(0, 3).map((track: any) => (
                            <li key={track.id}>
        ...
        >
          ...
          {results.genre && (
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-white mb-1">{results.genre.message}</p>
                {results.genre.data && (
                  <div className="mt-2 text-xs text-spotify-text-gray">
                    <p>Source: {results.genre.data.source}</p>
                    <p>License: {results.genre.data.license}</p>
                    {results.genre.data.tracks && results.genre.data.tracks.length > 0 && (
                      <div className="mt-2">
                        <p className="font-semibold mb-1">Sample tracks:</p>
                        <ul className="list-disc list-inside space-y-1">
                          {results.genre.data.tracks.slice(0, 3).map((track: any) => (
                            <li key={track.id}>
                              {track.name} by {track.artist}
                            </li>
                          ))}
