...
export default function RadioDashboardPage() {
  ...
  const totalEarnings = stations.reduce(
    (sum, station) => sum + station.earnings,
    0,
  );
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            >
              <li>
                You must have proper <strong>broadcasting licenses</strong> and
                rights to stream music content
              </li>
              <li>
                Music licensing through{" "}
                <strong>Performance Rights Organizations (PROs)</strong> like
                ASCAP, BMI, SESAC required
              </li>
              <li>
                Digital performance rights secured for online streaming
                distribution
              </li>
              <li>
                Station identification and branding must not infringe on
                existing trademarks
              </li>
              <li>
                Compliance with FCC regulations (if applicable) and
                international broadcasting laws
              </li>
              <li>
                Proper metadata and station information (call letters, format,
            ...
            <tbody>
              {stations.map((station) => (
                ...
                >
                  ...
                  <td className="py-3 text-spotify-text-gray">
                    {new Date(station.uploadDate).toLocaleDateString()}
                  </td>
                  <td className="py-3">
                    <span
          ...
          <div className="flex items-center justify-between p-4 bg-spotify-dark-gray rounded-lg">
            <div>
              ...
              <div className="text-xs text-spotify-text-gray mt-1">
                Ad revenue from audio spots, sponsorships, and brand
                partnerships
              </div>
              <div className="text-xs text-spotify-text-gray mt-1">
                Plus subscription revenue from premium memberships (ad-free,
                exclusive content)
              </div>
              <div className="text-xs text-spotify-text-gray mt-1">
