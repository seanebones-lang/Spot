...
=======
          ...
          >
            Your safety and privacy are our top priorities. Learn about our policies, 
            tools, and resources to help you stay safe and in control of your data.
>>>>>>> 460cde8a4456665eaca40b34f2a2a146c789ce1e
          </p>
        </div>
...
=======
              ...
              },
              {
                icon: Lock,
                title: 'Security Settings',
                description: 'Manage your account security, passwords, and two-factor authentication.',
                href: '/settings/security',
                color: 'from-green-500 to-green-600'
              },
              {
                icon: Eye,
                title: 'Privacy Settings',
                description: 'Control who can see your activity, profile, and listening history.',
                href: '/settings/privacy',
                color: 'from-purple-500 to-purple-600'
              },
              {
                icon: Users,
                title: 'Community Guidelines',
                description: 'Our community standards and expectations for respectful interaction.',
                href: '/community',
                color: 'from-yellow-500 to-yellow-600'
              },
              {
                icon: AlertTriangle,
                title: 'Report Content',
                description: 'Report inappropriate content, harassment, or copyright violations.',
                href: '/support',
                color: 'from-red-500 to-red-600'
              },
              {
                icon: FileText,
                title: 'Legal Documents',
                description: 'Terms of Service, DMCA Policy, and other legal information.',
                href: '/legal',
                color: 'from-gray-500 to-gray-600'
              }
>>>>>>> 460cde8a4456665eaca40b34f2a2a146c789ce1e
...
=======
                  title: 'Data Control',
                  description: 'You have the right to access, update, or delete your personal data at any time through your account settings.'
                },
                {
                  title: 'Data Minimization',
                  description: 'We only collect data necessary to provide our services and improve your experience. You can opt out of optional data collection.'
                },
                {
                  title: 'Transparency',
                  description: 'We clearly explain what data we collect, why we collect it, and how we use it in our Privacy Policy.'
                },
                {
                  title: 'Security',
                  description: 'We use industry-standard encryption, secure authentication, and regular security audits to protect your information.'
                }
              ].map((right, index) => (
                <div 
                  key={index}
...
=======
                  title: 'Blocking Users',
                  description: 'You can block users to prevent them from viewing your profile or contacting you. Blocked users cannot see your activity or send you messages.',
                  action: 'Go to Settings → Privacy'
                },
                {
                  title: 'Reporting Content',
                  description: 'If you encounter inappropriate content, harassment, or copyright violations, you can report it directly from the content or user profile.',
                  action: 'Use the Report button on any content'
                },
                {
                  title: 'Private Mode',
                  description: 'Enable private mode to hide your listening activity from others. Your playlists and profile remain visible, but your real-time activity is private.',
                  action: 'Go to Settings → Privacy → Private Mode'
                },
                {
                  title: 'Data Download',
                  description: 'You can download a copy of all your data, including playlists, listening history, and account information, at any time.',
                  action: 'Go to Settings → Account → Download Data'
                }
              ].map((resource, index) => (
                <div 
...
=======
            ...
            >
              Our support team is here to help with any privacy or safety concerns.
            </p>
            <Link
              href="/support"
