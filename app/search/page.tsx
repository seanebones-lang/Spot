...
const browseCategories: BrowseCategory[] = [
  ...
  },
  {
    ...
    category: "music",
    image:
      "https://images.unsplash.com/photo-1461784180009-21121b2f2044?w=400&h=400&fit=crop&q=80",
  },
  {
    id: "metal",
    title: "Metal",
  ...
  },
  {
    ...
    category: "podcasts",
    image:
      "https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=400&h=400&fit=crop&q=80",
  },
  {
    id: "mental-health-podcasts",
    title: "Mental Health Podcasts",
    href: "/radio?filter=mental-health",
    color: "#E61E32",
    category: "podcasts",
    image:
  ...
  // Features - Spotify Personalized
  {
    id: "made-for-you",
    title: "Made For You",
    href: "/search?q=made%20for%20you",
    color: "#0D73EC",
    category: "features",
    image:
  ...
  },
  {
    ...
    href: "/search?q=discover%20weekly",
    color: "#7209B7",
    category: "features",
    image:
      "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&h=400&fit=crop&q=80",
  ...
  },
  {
    ...
    category: "features",
    image:
      "https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?w=400&h=400&fit=crop&q=80",
  },
  {
    id: "live-broadcasts",
  ...
  {
    id: "withdrawal",
    title: "Withdrawal Sounds",
    href: "/categories/withdrawal",
    color: "#8D67AB",
    category: "mental-health",
    image:
  ...
  },
  {
    ...
    category: "account",
    image:
      "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=400&h=400&fit=crop&q=80",
  },
  {
    id: "settings",
    title: "Settings",
  ...
  },
  {
    id: "business",
    title: "Business",
    href: "/radio?filter=business",
    color: "#0D73EC",
    category: "podcasts",
    image:
      "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=400&h=400&fit=crop&q=80",
  },
  {
    id: "education",
    title: "Education",
    href: "/radio?filter=education",
    color: "#7209B7",
    category: "podcasts",
    image:
  ...
  },
  {
    id: "news",
    title: "News",
    href: "/radio?filter=news",
    color: "#BA5D07",
    category: "podcasts",
    image:
      "https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=400&h=400&fit=crop&q=80",
  },
  {
    id: "technology",
    title: "Technology",
    href: "/radio?filter=technology",
    color: "#509BF5",
    category: "podcasts",
    image:
  ...
  },
  {
    id: "entertainment",
    title: "Entertainment",
    href: "/radio?filter=entertainment",
    color: "#E8115B",
    category: "podcasts",
    image:
      "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=400&h=400&fit=crop&q=80",
  ...
  {
    id: "therapy-directory",
    title: "Therapy Directory",
    href: "/wellness/therapy",
    color: "#457B9D",
    category: "mental-health",
    image:
  ...
  // Additional Artist Features
  {
    ...
    href: "/dashboard/artist/marketing",
    color: "#8400E7",
    category: "artist",
    image:
      "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=400&fit=crop&q=80",
  },
  {
    id: "payouts",
  ...
  // Device & Settings
  {
    ...
    category: "account",
    image:
      "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=400&h=400&fit=crop&q=80",
  },
  {
    id: "privacy",
  ...
  },
  {
    id: "downloads",
    title: "Downloads",
    href: "/collection?filter=downloaded",
    color: "#7209B7",
    category: "account",
    image:
      "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=400&h=400&fit=crop&q=80",
...
export default function SearchPage() {
  ...
  const tracksByQuery = tracks.filter(
    (track) =>
  ...
  const albumsByQuery = albums.filter(
    (album) =>
  ...
  const filteredTracks =
    activeFilter === "all" || activeFilter === "music" ? tracksByQuery : [];
  const filteredArtists =
    activeFilter === "all" || activeFilter === "music" ? artistsByQuery : [];
  ...
  const filteredAlbums =
    activeFilter === "all" || activeFilter === "music" ? albumsByQuery : [];
  ...
  const categorySections = {
    ...
    "mental-health": browseCategories.filter(
      (c) => c.category === "mental-health" && c.id !== "mood",
    ),
    ...
    features: browseCategories.filter(
      (c) =>
        c.category === "features" &&
        ![
          "discover-weekly",
      ...
      >
        ...
        >
          <div className="space-y-12">
            {Object.entries(categorySections).map(
              ([sectionKey, categories]) => {
                ...
                if (activeFilter === "music") {
                  filteredCategories = categories.filter(
                    (c) => c.category === "music" || c.category === "genres",
                  );
                } else if (activeFilter === "podcasts") {
                  filteredCategories = categories.filter(
                    (c) => c.category === "podcasts",
                  );
