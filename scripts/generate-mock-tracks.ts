...
async function generateMockData() {
  ...
  const csvHeader =
    "id,title,artist,url,duration,genre,mood,license,cover_art,has_artwork\n";
  ...
  const artworkPercentage = ((artworkCount / allTracks.length) * 100).toFixed(
    1,
  );
